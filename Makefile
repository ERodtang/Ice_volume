...
SOURCES = \
	__init__.py \
	ice_volume.py ice_volume_dialog.py

PLUGINNAME = ice_volume

PY_FILES = \
	__init__.py \
	ice_volume.py ice_volume_dialog.py

UI_FILES = ice_volume_dialog_base.ui
...
QGISDIR=C:\Users\einararo\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
